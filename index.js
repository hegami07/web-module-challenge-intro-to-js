...
let champion = 'riven';
let exiled = 'broken blade';
if(exiled==='broken blae') {
  champion='yasuo';
}
  else {
     champion= 'riven';
  }
console.log ('task 1b', champion);
...
console.log('task 2', hungryDog(15,1))
...
*/
function annoyingSong(sodaQuantity){
  for (let i=sodaQuantity;i>0;i--) {
